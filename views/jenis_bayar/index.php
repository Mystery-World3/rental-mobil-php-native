...
<body id="page-top">
	...
	<div id="content-wrapper" class="d-flex flex-column">
		<div id="content" style="background-image: url('<?= base_url("assets/2.jpg") ?>'); background-repeat: repeat; background-size: 500px 500px;">
		<?php partial('topbar') ?>
						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('jenis_bayar/tambah') ?>">
								  	...
								  	<div class="form-group">
										<button type="submit" class="btn btn-sm btn-success" name="tambah" onclick="return confirm('Yakin ingin menambahkan data jenis bayar ini?')">><i class="fa fa-plus"></i> Tambah</button>
